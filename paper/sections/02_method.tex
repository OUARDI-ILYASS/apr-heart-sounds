...
\input{figs/pipeline/fig_pipeline}
...
\input{figs/pipeline/fig_preprocessing}
...
% \input{figs/pipeline/fig_features}
...
% \input{figs/pipeline/fig_models}
% \input{figs/pipeline/fig_evaluation}
\input{figs/pipeline/fig_diagnostics}
