...
The official challenge test set was never publicly released; it remained on the
challenge server. All results below therefore come from a self-defined split of
the public training data, and published challenge scores are context rather
than a like-for-like comparison. We restate this wherever those numbers appear.
